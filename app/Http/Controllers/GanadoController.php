...
class GanadoController extends Controller
{
    ...
    private function reglasValidacionSanitaria(): array
    {
        return [
            ...
            'certificado_imagen' => 'nullable|image|max:5120',
            'certificado_campeon_imagen' => 'nullable|image|max:5120',
            'arbol_genealogico' => 'nullable|file|mimes:pdf,jpg,jpeg,png,gif|max:10240',
            'marca_ganado' => 'nullable|string|max:255',
            'marca_ganado_foto' => 'nullable|image|max:5120',
            'senal_numero' => 'nullable|string|max:255',
            'nombre_dueno' => 'nullable|string|max:255',
            'carnet_dueno_foto' => 'nullable|image|max:5120',
