...
class StoreMaquinariaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'precio_dia' => 'required|numeric|min:0|max:10000000',
            'tarifa_unidad' => 'required|in:hora,dia',
            'estado_maquinaria_id' => 'nullable|exists:estado_maquinarias,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'precio_dia.required' => 'La tarifa por hora es obligatoria.',
            'precio_dia.numeric' => 'La tarifa por hora debe ser un número válido.',
            'precio_dia.min' => 'La tarifa por hora no puede ser negativa.',
