                ...
                @if ($maquinaria->user)
                    <div class="seller-card mb-3">
                        ...
                        <div class="card-body p-4">
                                ...
                                @if (auth()->id() !== $maquinaria->user_id)
                                    <div class="mt-3 pt-3 border-top">
                                        <a href="mailto:{{ $maquinaria->user->email }}"
                                            class="btn btn-success-modern btn-block btn-modern mb-2">
                            ...
                            @else
                                <div class="mt-3 pt-3 border-top">
                                    <a href="{{ route('login') }}" class="btn btn-outline-success btn-block btn-modern mb-2">
                                        <i class="fas fa-sign-in-alt mr-2"></i> Inicia sesión para contactar
                                    </a>
                                </div>
                            @endauth

                            <a href="{{ route('productor.show', $maquinaria->user->id) }}" class="btn btn-outline-primary btn-block btn-modern shadow-sm mt-2">
