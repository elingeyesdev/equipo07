                ...
                @if ($ganado->user)
                    <div class="card shadow-sm border-0 border-success" style="border-width: 3px !important;">
                        ...
                        <div class="card-body">
                                ...
                                @if (auth()->id() !== $ganado->user_id)
                                    <div class="mt-2 pt-2 border-top">
                                        <a href="mailto:{{ $ganado->user->email }}"
                                            class="btn btn-success btn-sm btn-block shadow-sm mb-2">
                            ...
                            @else
                                <div class="mt-2 pt-2 border-top">
                                    <a href="{{ route('login') }}" class="btn btn-outline-success btn-sm btn-block mb-2">
                                        <i class="fas fa-sign-in-alt mr-1"></i> Inicia sesión para contactar
                                    </a>
                                </div>
                            @endauth

                            <a href="{{ route('productor.show', $ganado->user->id) }}" class="btn btn-outline-primary btn-sm btn-block shadow-sm">
                                <i class="fas fa-user-circle mr-1"></i> Ver Perfil Completo
                            </a>
                        </div>
                    </div>
                @endif
