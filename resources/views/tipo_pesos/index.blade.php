...
@section('content')
    ...
    <div class="card card-outline card-success">
        <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div>
                <h3 class="card-title font-weight-bold">Tipos de Pesaje</h3>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($items as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <form action="{{ route('admin.tipo-pesos.destroy', $item->id) }}" method="POST" class="d-inline delete-form" data-message="¿Está seguro de eliminar {{ $item->nombre }}?">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted py-5">No hay tipos de pesaje registrados aún.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Agregar Tipo de Pesaje</h5>
...
@section('js')
<script>
    const urlStore = "{{ route('admin.tipo-pesos.store') }}";
    const urlUpdateBase = "{{ url('admin/tipo-pesos') }}";

    function abrirModalCrear() {
        $('#modalTitle').text('Agregar Tipo de Pesaje');
    ...
    function abrirModalEditar(id, nombre, descripcion) {
        $('#modalTitle').text('Editar Tipo de Pesaje');
