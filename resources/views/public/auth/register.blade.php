            ...
            <section class="auth-hero" aria-label="Crear cuenta en AgroVida Bolivia">
                ...
                <div class="auth-hero-content">
                    <div class="auth-hero-brand">
                        <img src="{{ asset('img/brand/logo-agrovida.jpeg') }}?v={{ filemtime(public_path('img/brand/logo-agrovida.jpeg')) }}" alt="AgroVida" class="auth-hero-logo">
            ...
            <section class="auth-form-panel" aria-label="Formulario de registro">
                <div class="auth-login-card auth-register-card">
                    <div class="auth-login-brand">
                        <img src="{{ asset('img/brand/logo-agrovida.jpeg') }}?v={{ filemtime(public_path('img/brand/logo-agrovida.jpeg')) }}" alt="AgroVida" class="auth-login-logo">
                    </div>
